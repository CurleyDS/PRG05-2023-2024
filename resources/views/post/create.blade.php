                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8">
                            <div class="col-span-3">
                                ...
                                <div class="mt-2">
                                    <textarea id="text" name="text" rows="4" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 @error('text') is-invalid @enderror" placeholder="What is happening?" required>{{ old('text') }}</textarea>
